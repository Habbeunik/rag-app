...
export default function UploadPage({ onFilesUploaded }: UploadPageProps) {
  ...
  const processPDF = async (file: File): Promise<string> => {
    // Extract text client-side using simplified utility
    setProcessingStatus("Extracting text from PDF...");
    const text = await extractPDFText(file);

    // Send text to server for chunking and embedding
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            >
              Transform your PDF into an intelligent conversation partner.
              Upload a document and get instant, contextual answers powered by
              AI.
            </motion.p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center gap-2 text-sm text-[#7d8590] bg-[#0d1117] rounded-lg p-3 border border-[#21262d]">
                  <div className="flex items-center gap-2">
                    <FileText size={16} />
                    <span>Supports one PDF file up to 10MB</span>
                  </div>
          ...
          >
            <div className="glass-card p-6 text-center group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-sm text-[#7d8590]">
                Advanced AI understands your document context and provides
            ...
            <div className="glass-card p-6 text-center group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-sm text-[#7d8590]">
                Your document is processed securely with privacy protection
              </p>
            </div>
            ...
            <div className="glass-card p-6 text-center group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-sm text-[#7d8590]">
                Get instant answers and insights from your document
              </p>
            </div>
          </motion.div>
        </div>
